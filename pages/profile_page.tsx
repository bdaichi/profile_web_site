...
export default function ProfilePage() {
    ...
    return (
        <div style={{ backgroundColor: isDarkMode ? 'black' : 'white' }}>
            ...
            <div className='flex justify-center z-0' style={{ backgroundColor: isDarkMode ? 'black' : 'white' }}>
                <img className='opacity-25 mt-20 w-64 md:mt-36 w-72' src='profile.jpg' />
            </div>
            <div className='flex flex-col justify-center z-10 m-8' style={{ backgroundColor: isDarkMode ? 'black' : 'white' }}>
