    ...
    return (
        <div style={{ backgroundColor: isDarkMode ? 'black' : 'white' }}>
            ...
            <div>{portfolioName == 'VisitorForecastApp' &&
                <PortfolioField portfolioName={portfolioName} imagePath='visitorForecastApp.jpg' summary={visitorForecastAppSummary} portfolioURL='' isDarkMode={isDarkMode} setIsDarkMode={setIsDarkMode} isReloadDarkMode={isReloadDarkMode} setIsReloadDarkMode={setIsReloadDarkMode} />
            }</div>
            <div>{portfolioName == 'chatApp' &&
                <PortfolioField portfolioName={portfolioName} imagePath='chatApp.jpg' summary={chatAppSummary} portfolioURL='' isDarkMode={isDarkMode} setIsDarkMode={setIsDarkMode} isReloadDarkMode={isReloadDarkMode} setIsReloadDarkMode={setIsReloadDarkMode} />
            }</div>
        </div>
    )
}