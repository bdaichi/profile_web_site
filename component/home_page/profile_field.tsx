...
export default function ProfileField(props: Props) {
    ...
    return (
        <>
            ...
            >
                <div className='mt-16 md:fixed md:top-44 md:left-8 p-8 border-b md:border-2 rounded-md md:p-4 z-10 flex flex-col justify-center items-center m-4' style={{ backgroundColor: props.darkMode ? 'black' : 'white', borderColor: props.darkMode ? '#01a9f4' : 'white', borderTopWidth: 0.5, borderLeftWidth: 1, borderBottomWidth: 3, borderRightWidth: 1, }}>
