    ...
    return (
        <>
            ...
            <div className='flex flex-col justify-center md:flex-row mt-52 md:mt-72' style={{ color: props.isDarkMode ? '#00a9f4' : 'black', backgroundColor: props.isDarkMode ? 'black' : 'white' }}>
                ...
                <div className='flex flex-col justify-center items-center'>{props.portfolioURL &&
                    <div className="flex flex-col justify-center items-center">
                        <p className='flex justify-center  md:absolute md:top-52' style={{ color: props.isDarkMode ? 'white' : 'black' }}>こちらから開けます！ぜひ！どうぞ！！</p>
                        <a className='flex justify-center border-b border-blue-400 md:absolute md:top-60' style={{ color: '#00a9f4', }} href={props.portfolioURL}>{props.portfolioURL}</a>
                    </div>
                }</div>
