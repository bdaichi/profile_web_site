...
export default function HobyyField(props: Props) {
  return (
    <>
      <p
        className="flex justify-center text-xl py-4"
      ...
      >
        ...
        楽しいです。夏までに一回り体を大きくするのが今の目標です。
        筋肉は１日にしてならず、継続してトレーニングに励みたいです。
        ちなみに好きな筋肉はハムストリングとトライセラトップスで、理由は
        名前がかっこいいのと、効かせてるときの感触が好きだからです！
      </p>
      <div
        className="flex flex-col justify-center items-center my-10"
        style={{ color: props.isDarkMode ? "white" : "black" }}
      >
        <p className="text-sm" style={{ fontFamily: "Hannotate SC" }}>
          　↓　首と顎つながっとるやん
        </p>
        ...
        <p>↓</p>
        <p className="mt-2" style={{ fontFamily: "Hannotate SC" }}>
          ぱわーーー！！！
        </p>
