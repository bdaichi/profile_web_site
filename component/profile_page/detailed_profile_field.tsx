export default function DetailedProfileField() {
    ...
    return (
        <div className='flex flex-col items-center font-extrabold absolute top-28 md:top-44' style={{ fontFamily: '筑紫A丸ゴシック', color: '#007ac1', WebkitTextStroke: '0.4px white' }}>
            <img className='flex justify-center items-center rounded-full h-36 w-36 my-8' src='kimoi_face.jpg' />
